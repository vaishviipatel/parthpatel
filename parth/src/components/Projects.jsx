...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      liveDemo: "#",
      github: "https://github.com/parthgiht/Telecom-Customer-Churn-Prediction" // ← add real GitHub link when you upload it
    },
    {
      ...
      liveDemo: "#",
      github: "https://github.com/parthgiht/Real-Estate-Valuation-and-Personalized-Flat-Recommendation-System" // ← add real GitHub link when ready
    },
    {
          ...
          {projects.map((project, index) => (
            <div key={index} className="project-card">
              ...
              <div className="project-actions">
                {/* Live Demo button - disabled/gray if no real link */}
                <a
                  href={project.liveDemo}
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`btn-live-demo ${project.liveDemo === "#" ? "disabled" : ""}`}
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`btn-github ${project.github === "#" ? "disabled" : ""}`}
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`btn-kaggle ${project.kaggle === "#" ? "disabled" : ""}`}
                  onClick={project.kaggle === "#" ? (e) => e.preventDefault() : undefined}
                >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
